...
function preload(){
  ...
  squirrelFlip=loadImage("assets/images/squirrelFlip.png");
...
function draw() {
  ...
  if (gameState==INTRO){
    ...
    //show text of story and rules
    fill("black");
    textSize(15);
    text("Welcome to Squirrel Hunt! In this game, you are the squirrel who is hunting for nuts in the jungle to feed your family", 10, 250);
    text("and a snake is chasing you! You need to collect 30 nuts and get back to your family before you lose all your lives!" ,10, 270);
    text("Collecting a normal brown nut gives 1 collection point. Collecting a golden nut give a life and 1 collection point! After", 10, 290);
    text("you lose your first life, the maze will start closing in on you! Use the arrow keys to move throughout the maze and", 10, 310);
    text("collect the 30 nuts. Press N to move on, Good Luck!", 200, 330);
  ...
  if (gameState==START){
    ...
    fill("red");
    text ("Press the S key to start", gameWidth/2,gameHeight/9);
